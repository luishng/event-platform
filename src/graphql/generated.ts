...
export type GetLessonSlugQueryVariables = Exact<{
  slug?: InputMaybe<Scalars['String']>;
}>;


export type GetLessonSlugQuery = { __typename?: 'Query', lesson?: { __typename?: 'Lesson', title: string, videoId: string, description?: string | null, teacher?: { __typename?: 'Teacher', name: string, bio: string, avatarURL: string } | null } | null };
...
export const GetLessonSlugDocument = gql`
...
/**
 * __useGetLessonSlugQuery__
 *
 * To run a query within a React component, call `useGetLessonSlugQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetLessonSlugQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetLessonSlugQuery({
 *   variables: {
 *      slug: // value for 'slug'
 *   },
 * });
 */
export function useGetLessonSlugQuery(baseOptions?: Apollo.QueryHookOptions<GetLessonSlugQuery, GetLessonSlugQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetLessonSlugQuery, GetLessonSlugQueryVariables>(GetLessonSlugDocument, options);
      }
export function useGetLessonSlugLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetLessonSlugQuery, GetLessonSlugQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetLessonSlugQuery, GetLessonSlugQueryVariables>(GetLessonSlugDocument, options);
        }
export type GetLessonSlugQueryHookResult = ReturnType<typeof useGetLessonSlugQuery>;
export type GetLessonSlugLazyQueryHookResult = ReturnType<typeof useGetLessonSlugLazyQuery>;
export type GetLessonSlugQueryResult = Apollo.QueryResult<GetLessonSlugQuery, GetLessonSlugQueryVariables>;